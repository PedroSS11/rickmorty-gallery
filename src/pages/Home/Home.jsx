    ...
    <div className={styles.home}>
      ...
      <div className={styles.texts}>
        ...
        <div className={styles.left__text}>
          ...
          <p>
            API Rick and Morty é uma API REST baseada no programa de televisão Rick and Morty. Neste app você terá acesso a uma galeria com todos os personagens do desenho, nomes, locais de origem, e mais !
          </p>
